...
<dl>
    <dt>Metasploit</dt>
        <dd>-[Setting up Oracle with msfconsole](https://github.com/rapid7/metasploit-framework/wiki/How-to-get-Oracle-Support-working-with-Kali-Linux)</dd>
        <dd>-[Setting up Oracle with Kali Linux](https://blog.zsec.uk/msforacle/)</dd>
    <dt>ODAT</dt>
        <dd>-[Installing ODAT](https://github.com/quentinhardy/odat/blob/master/README.md) (scroll down to the install section)</dd>
</dl> 
...
<a href="https://v3ded.github.io/img/blog/htb-silo/htb-silo-05.png" target=_blank>
