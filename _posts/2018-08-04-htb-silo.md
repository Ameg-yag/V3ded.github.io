...
<dl>
    <dt>Metasploit</dt>
    <dd><a href src="https://github.com/rapid7/metasploit-framework/wiki/How-to-get-Oracle-Support-working-with-Kali-Linux" target=_blank>-Setting up Oracle with msfconsole</a></dd>
    <dd><a href src="https://blog.zsec.uk/msforacle/" target=_blank>-Setting up Oracle with Kali Linux</a></dd>
    <dt>ODAT</dt>
    <dd><a href src="https://github.com/quentinhardy/odat/blob/master/README.md" target=_blank>-Installing ODAT</a> (scroll down to the install section)</dd>
</dl> 
