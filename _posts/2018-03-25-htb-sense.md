...
## Using Metasploit
As it appears, there is also a metasploit module which simplifies everything we've done so far. The [exploit](https://www.rapid7.com/db/modules/exploit/unix/http/pfsense_graph_injection_exec) is very simple and all that's required is setting up LHOST, LPORT, RHOST and the rohit username. You know the drill.
